def origem_destino_iguais(origem, destino, lista_de_erros):
    """Verifica se origem e destino são iguai"""
    if origem == destino:
        lista_de_erros['destino'] ="Origem e destino não podem ser iguais"

def campo_tem_algum_numero(valor_campo, nome_campo, lista_de_erros):
    """Verifica se possui algum caracter numerio"""
...
def data_ida_maior_data_volta(data_ida, data_volta, lista_de_erros):
    """Verifica se data de ida for maior que data de volta"""
    if data_ida > data_volta:
        lista_de_erros['data_volta']= "Data de ida não pode ser menor que a data de volta"
